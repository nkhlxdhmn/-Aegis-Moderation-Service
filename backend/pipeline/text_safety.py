    ...
    "hate_speech_score": (
        ...
        TextRule(
            (
                ...
                "attack this religion",
                "caste based attack",
                "ethnicity based attack",
                "race based attack",
                "nationality based attack",
                "all muslims are terrorists",
                "all hindus are extremists",
        ...
        TextRule(
            (
                ...
                "bhangi",
                "chamar gali",
                "musalman desh se nikalo",
                "hindu desh se nikalo",
