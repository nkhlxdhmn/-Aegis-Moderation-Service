...
HARD_BLOCK_PHRASES: frozenset[str] = frozenset({
    ...
    "follow us", "follow me", "follow for more", "follow for follow",
    "follow back", "follow my page", "follow our page",
    "follow my account", "follow my profile",
    "follow my instagram", "follow my insta",
    "follow karo", "hamara follow karo", "follow kar",
    "subscribe", "subscribe now", "subscribe to",
    "subscribe karo", "subscribe kar",
    "like and subscribe", "like share subscribe",
    "join now", "join our", "join my", "join telegram", "join whatsapp",
    "join channel", "join group", "join karo",
    "telegram channel", "telegram group",
    "whatsapp group", "whatsapp channel", "whatsapp me",
    "discord server",
    "link in bio", "link in story", "check our link", "check link",
    "dm me", "dm for", "dm for details", "dm for price",
    "message me", "inbox me",

    # ── Commercial promotion ──────────────────────────────────────────────────
    "discount", "coupon code", "promo code", "use code",
    "buy now", "shop now", "order now", "purchase now",
    "limited offer", "limited time offer", "offer ends",
    "sale today", "today only",
    "50% off", "40% off", "30% off", "20% off", "flat off", "upto off",
    "free course", "free class", "free training", "free workshop",
    "free webinar", "free masterclass", "free batch", "free session",
    "paid course", "paid class", "paid training", "paid batch",
    "enroll now", "enroll today",
    "register now", "registration open", "register free",
    "book now", "book your seat", "book your slot",
    "100% free", "totally free", "absolutely free",
    "earn money", "make money", "earn from home", "work from home",
    "passive income", "refer and earn",
    "batch starting", "batch starts", "next batch", "new batch",
    "morning batch", "evening batch", "weekend batch",
    "get certified", "certification course",
    "seats are limited", "limited seats",
    # Hindi transliterations of promotional phrases
    "muft course", "muft class", "muft training",
    "abhi register karo", "abhi join karo",
    "link dekhiye", "link pe click karo",
    "course join karo", "batch join karo",
    "paise kamao", "ghar baithe kamao",
    ...
    "kill muslims", "kill hindus", "kill jews", "kill christians",
    "kill sikhs", "kill dalits", "kill brahmins",
    "death to muslims", "death to hindus", "death to jews",
    "death to christians", "death to sikhs",
    "hang muslims", "hang hindus", "hang them",
    "lynch them", "lynch muslims", "lynch hindus",
    "boycott muslims", "boycott hindus", "boycott christians",
    "boycott sikhs", "boycott jews",
    "expel muslims", "expel hindus", "expel christians",
    "ethnic cleansing", "genocide", "exterminate",
    "white supremacy", "hindu supremacy", "islamic supremacy",
    "religious war", "holy war against",
    "gas them", "burn them all",
    "rape them",
...
VIOLENCE_WORDS: frozenset[str] = frozenset({
    "boycott", "expel", "eliminate", "destroy", "kill", "hang", "lynch",
})
COMMUNITY_WORDS: frozenset[str] = frozenset({
    "muslim", "muslims", "hindu", "hindus", "christian", "christians",
    "sikh", "sikhs", "jewish", "jews", "dalit", "dalits",
    "brahmin", "brahmins", "black", "white", "asian", "arab",
})
